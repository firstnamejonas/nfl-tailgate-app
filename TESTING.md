...
| As a new signed up user I can choose my favorite team so that I can participate in the chat room of my favorite team. | ![screenshot](documentation/features/feature-favorite-team.png) ![screenshot](documentation/features/feature-favorite-team-02.png) ![screenshot](documentation/features/feature-favorite-team-03.png) |
| As a logged in user I can go to the main user page where i can find and overview all chats on the app so that can join different chat rooms. | ![screenshot](documentation/features/feature-chatrooms.png) |
...
| As a user in a chatroom, I can send messages in all chat rooms, once entered, except in those chatrooms that are from other teams that are not my favorite team so that I can communicate with other users. | ![screenshot](documentation/features/feature-chat.png) |
